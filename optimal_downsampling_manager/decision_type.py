...
class Decision():
    def __init__(self, clip_name='None', a_type='None', d_type='None', a_parameter=-1, fps=24.0, bitrate=1000.0, prev_fps=24.0, prev_bitrate=1000.0, others=[0,0,0], shot_list=[]):
