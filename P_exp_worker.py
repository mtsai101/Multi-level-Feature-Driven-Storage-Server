...
#     count=0
#     prev_amount = 0
#     with open("experiments/P_"+algo+"_ia_hours_GB.csv",'w') as csvfile:
...
#     count=0
#     prev_amount = 0
#     with open("experiments/P_"+algo+"_clips_hours_GB.csv",'w') as csvfile:
#         writer = csv.writer(csvfile)
#         for r in result_list:
#             while count != int(r['hour']):
#                 writer.writerow([prev_amount])
...
#     count=0
#     prev_amount = 0
#     with open("experiments/P_"+algo+"_space_hours_GB.csv",'w') as csvfile:
#         writer = csv.writer(csvfile)
#         for r in result_list:
#             while count != int(r['hour']):
#                 writer.writerow([prev_amount])
